...
void main() {
  ...
  group('Map & Layout Overflow Regression Tests', () {
    testWidgets(
      'OpenStreetMapWidget renders safely with extreme risk scores and long city names',
      (tester) async {
        ...
        final target = const TargetLocation(
          name:
              "Afyonkarahisar Zafer Meydanı ve Valilik Binası Kontrol Noktası",
          latitude: 38.7569,
          longitude: 30.5387,
          radius: 250.0,
        );
        ...
        final province =
            TurkeyProvinces.getByPlateCode(3) ?? TurkeyProvinces.all.first;
    ...
    testWidgets(
      'WelcomeScreen renders on small screens without RenderFlex overflow',
      (tester) async {
